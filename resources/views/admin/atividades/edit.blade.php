    ...
    <div class="px-4 container-fluid">
        ...
        <div class="mb-4 shadow card border-light">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('atividade.update', ['atividade' => $atividade]) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-2">
                            <input type="date" id="data_registro" class="form-control" name="data_registro" value="{{old('data_registro', $atividade->data_registro) }}" >
                            @error('data_registro')
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-5">
                        <textarea rows="3" class="form-control" id="descricao" name="registro" > {{ old('registro', $atividade->registro) }} </textarea>
                          @error('registro')
                              <small style="color: red">{{$message}}</small>
                          @enderror
                        </div>
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-2">
                            <input type="number" name="progresso" value="{{ old('progresso', $atividade->progresso) }}" class="form-control" id="progresso"  min="1" max="100">
                            @error('progresso')
                              <small style="color: red">{{$message}}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-10">
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="obraconcluida" id="obraconcluidasim" value="1" {{old('obraconcluida', $atividade->obraconcluida) == '1' ? 'checked' : ''}} reuired>
                                    <label class="form-check-label" for="obraconcluidasim">Sim</label>

                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="obraconcluida" id="obraconcluidanao" value="0" {{old('obraconcluida', $atividade->obraconcluida) == '0' ? 'checked' : ''}} >
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-5">
                        <textarea rows="3" class="form-control" id="observacao" name="observacao" > {{ old('observacao', $atividade->observacao) }} </textarea>
                          @error('observacao')
                              <small style="color: red">{{$message}}</small>
                          @enderror
                        </div>
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-sm-5">
                            <div style="margin-top: 15px">
                                ...
                                <a class="btn btn-outline-secondary" href="{{ route('atividade.indexregistros', ['obra' => $obra]) }}" role="button">Cancelar</a>
