    ...
    <table style="width: 1080px; border-collapse: collapse;">
        ...
        @foreach ($escolas as $escola)
            <tr @if($loop->even) style="background-color: #e3e3e3;" @endif>
                ...
                <td style="width: 300px;" class="dados-lista">{{$escola->nome}}</td>
                <td style="width: 290px;" class="dados-lista">{{ $escola->endereco }}</td>
                <td style="width: 150px;" class="dados-lista">{{$escola->regional->nome}}</td>
                <td style="width: 150px;" class="dados-lista">{{$escola->municipio->nome}}</td>
