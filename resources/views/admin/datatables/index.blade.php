                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            {{-- final formulário de cadastro de usuário --}}
...
@section('scripts')
    <script>
        ...
        const formNovoUsuario =  document.getElementById("formCadastrarUsuario");
        if(formNovoUsuario){
            formNovoUsuario.addEventListener("submit", async(e)  => {
                e.preventDefault();
                const formDadosFormularioCadastrarUsuario =  new FormData(formNovoUsuario);
                //alert(formDadosFormularioCadastrarUsuario);
            })
        }
