            ...
            <div class="card-body">
                ...
                <form action="{{ route('obra.store') }}" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        {{-- ativo --}}
                        <div class="col-2">
                            <div class="form-group focused"  style="margin-left: 150px;">
                    ...
                    {{-- objetos_id--}}
                    <fieldset style="margin-top: 40px; border: 1px solid #dddbdb; padding: 5px; border-radius: 5px;">
                        <legend style="text-align: center">OBJETOS</legend>
                            <div class="mb-3 row">
