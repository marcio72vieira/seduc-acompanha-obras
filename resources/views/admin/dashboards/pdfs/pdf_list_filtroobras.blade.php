    ...
    <table style="width: 1080px; border-collapse: collapse;">
        ...
        @foreach ($obras as $obra)
            <tr @if($loop->even) style="background-color: #e3e3e3;" @endif>
                ...
                <td style="width: 170px;" class="dados-lista">{{ $obra->objetos }}</td>
                <td style="width: 100px;" class="dados-lista">{{ $obra->regional }}</td>
                <td style="width: 100px;" class="dados-lista">{{ $obra->municipio }}</td>
                <td style="width: 100px;" class="dados-lista">{{ $obra->responsaveis }}</td>
                ...
                <td style="width: 70px;" class="dados-lista">{{ $obra->estatu }} ({{ $obra->progressomaximo }}%)</td>
            </tr>
        @endforeach
    </table>
</body>
